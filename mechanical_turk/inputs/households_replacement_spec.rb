...
describe "household replacement rate with NEW slider" do
  before :all do
    load_scenario(area_code: "nl", end_year: 2050, use_fce: false) do
      move_slider 901, 5.0       # households_replacement_of_existing_houses
    end
  end
...
describe "households with old slider" do
  before :all do
    load_scenario(area_code: "nl", end_year: 2050, use_fce: false) do
