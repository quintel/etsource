...
describe "untitled" do
  before :all do
    load_scenario(area_code: "nl", end_year: 2020, use_fce: false) do
      ...
      move_slider 372, -1.0       # households_heat_demand_per_person
      move_slider 204, 1.0       # households_cooling_demand_per_person
      move_slider 373, 0.0       # households_hot_water_demand_per_person
      ...
      move_slider 348, 2.0       # households_hot_water_solar_water_heater_share
      move_slider 349, 83.0       # not found
      move_slider 354, 45.0       # households_cooking_gas_share
      move_slider 355, 20.0       # households_cooking_electric_share
      move_slider 356, 10.0       # households_cooking_halogen_share
      move_slider 357, 25.0       # households_cooking_induction_share
      move_slider 6, 15.0       # households_efficiency_fridge_freezer
      move_slider 359, 10.0       # households_efficiency_dish_washer
      move_slider 360, 0.0       # households_efficiency_vacuum_cleaner
      move_slider 361, 10.0       # households_efficiency_washing_machine
      move_slider 362, 10.0       # households_efficiency_dryer
      move_slider 363, 0.0       # households_efficiency_television
      move_slider 364, 5.0       # households_efficiency_computer_media
      move_slider 412, 0.0       # households_efficiency_other
      move_slider 43, 50.0       # households_lighting_low_energy_light_bulb_share
      move_slider 44, 15.0       # households_lighting_light_emitting_diode_share
      move_slider 245, 35.0       # households_lighting_incandescent_share
      move_slider 366, 30.0       # households_behavior_standby_killer_turn_off_appliances
      move_slider 368, 30.0       # households_behavior_turn_off_the_light
      move_slider 370, 30.0       # households_behavior_close_windows_turn_off_heating
      move_slider 371, 20.0       # households_efficiency_low_temperature_washing
      move_slider 47, 2.0       # households_market_penetration_solar_panels
      ...
      move_slider 387, 1.0       # buildings_heating_electric_heater_share
      move_slider 388, 1.0       # buildings_heating_heat_network_share
      move_slider 389, 2.0       # buildings_heating_solar_thermal_panels_share
      move_slider 390, 1.0       # buildings_heating_gas_fired_heat_pump_share
      ...
      move_slider 409, 10.0       # buildings_heating_oil_fired_heater_share
      move_slider 395, 2.3       # buildings_ventilation_rate
      move_slider 396, 15.0       # buildings_recirculation
      move_slider 397, 25.0       # buildings_waste_heat_recovery
      move_slider 398, 1.0       # buildings_appliances_efficiency
      move_slider 400, 35.0       # buildings_lighting_fluorescent_tube_conventional_share
      move_slider 401, 50.0       # buildings_lighting_fluorescent_tube_high_performance_share
      move_slider 402, 15.0       # buildings_lighting_led_tube_share
      ...
      move_slider 405, 2.0       # buildings_market_penetration_solar_panels
      ...
      move_slider 148, 43.0       # transport_cars_gasoline_share
      move_slider 146, 3.0       # transport_cars_electric_share
      move_slider 147, 47.0       # transport_cars_diesel_share
      move_slider 238, 2.0       # transport_cars_lpg_share
      move_slider 239, 5.0       # transport_cars_compressed_gas_share
      move_slider 158, 95.0       # transport_trucks_diesel_share
      move_slider 157, 3.0       # transport_trucks_gasoline_share
      move_slider 159, 0.0       # transport_trucks_electric_share
      move_slider 240, 2.0       # transport_trucks_compressed_gas_share
      ...
      move_slider 202, 2.0       # industry_non_energetic_other_demand
      ...
      move_slider 218, 4.0       # industry_heating_coal_fired_heater_share
      move_slider 219, 1.0       # industry_heating_biomass_fired_heater_share
      move_slider 326, 45.0       # industry_heating_combined_heat_power_share
      move_slider 322, 125.0       # industry_number_of_gas_chp
      move_slider 323, 0.0       # not found
      move_slider 324, 10.0       # industry_number_of_biomass_chp
      ...
      move_slider 225, 1.0       # agriculture_heating_biomass_fired_heater_share
      move_slider 227, 4.0       # agriculture_heating_heat_pump_with_ts_share
      move_slider 228, 1.0       # agriculture_heating_geothermal_share
      move_slider 327, 24.1       # agriculture_heating_combined_heat_power_share
      move_slider 325, 3000.0       # agriculture_number_of_small_gas_chp
      move_slider 229, 1.4       # other_electricity_demand
      move_slider 230, 0.1       # other_heat_demand
      move_slider 321, 127.0       # other_number_of_small_gas_chp
      move_slider 198, -20.0       # policy_sustainability_co2_emissions
      move_slider 234, 20.0       # policy_sustainability_renewable_percentage
      move_slider 178, 200.0       # policy_area_onshore_land
      ...
      move_slider 194, 5.0       # policy_area_land_for_solar_panels
      move_slider 195, 5.0       # policy_area_land_for_csp
      move_slider 206, 60.0       # policy_dependence_max_dependence
      move_slider 212, 12.0       # policy_dependence_max_electricity_dependence
      move_slider 208, 25.0       # policy_cost_total_energy_cost
      move_slider 207, 25.0       # policy_cost_electricity_cost
      move_slider 11, 50.0       # costs_oil
      move_slider 57, 40.0       # costs_coal
      move_slider 58, 50.0       # costs_gas
      move_slider 59, 40.0       # costs_biomass
      move_slider 16, 10.0       # investment_costs_combustion_gas_plant
      move_slider 17, 15.0       # investment_costs_combustion_oil_plant
      move_slider 18, 20.0       # investment_costs_combustion_coal_plant
      ...
      move_slider 185, 50.0       # costs_uranium
      move_slider 136, 20.0       # investment_costs_nuclear_nuclear_plant
      move_slider 121, 20.0       # om_costs_nuclear_nuclear_plant
      move_slider 12, -10.0       # investment_costs_wind_onshore
      move_slider 14, -12.0       # investment_costs_wind_offshore
      move_slider 126, 5.0       # om_costs_wind_onshore
      move_slider 127, 10.0       # om_costs_wind_offshore
      move_slider 114, 10.0       # investment_costs_water_river
      move_slider 116, -60.0       # not found
      move_slider 129, 0.0       # om_costs_water_river
      move_slider 130, 0.0       # not found
      move_slider 133, -30.0       # investment_costs_solar_solar_panels
      move_slider 134, -10.0       # investment_costs_solar_concentrated_solar_power
      move_slider 247, -10.0       # investment_costs_earth_geothermal_electricity
      move_slider 132, 0.0       # om_costs_earth_geothermal_electricity
      move_slider 137, 50.0       # costs_co2
      move_slider 138, 50.0       # costs_co2_free_allocation
      move_slider 139, 0.0       # om_costs_co2_ccs
      move_slider 140, -5.0       # investment_costs_co2_ccs
      ...
      move_slider 488, 5.0       # green_gas_total_share
      move_slider 489, 95.0       # natural_gas_total_share
      move_slider 261, 0.8       # number_of_co_firing_coal
      move_slider 262, 0.0       # not found
      move_slider 263, 1300.0       # number_of_wind_onshore_land
      move_slider 264, 300.0       # number_of_wind_onshore_coast
      move_slider 265, 1000.0       # number_of_wind_offshore
      move_slider 266, 4.0       # number_of_hydro_river
      move_slider 268, 0.0       # not found
      move_slider 270, 0.0       # number_of_geothermal_electric
      move_slider 298, 2.0       # number_of_solar_pv_plants
      move_slider 299, 0.0       # number_of_concentrated_solar_power
      move_slider 271, 10.0       # number_of_waste_incinerator
      move_slider 292, 91.5       # transport_diesel_share
      move_slider 293, 8.5       # transport_biodiesel_share
      move_slider 294, 91.0       # transport_gasoline_share
      move_slider 295, 9.0       # transport_bio_ethanol_share
      move_slider 296, 40.0       # not found
      move_slider 297, 60.0       # not found
