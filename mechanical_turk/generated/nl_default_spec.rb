...
describe "nl" do
  context "without any updates" do
    ...
    it "check dashboard_energy_demand_primary_of_final" do
      ...
      @future.dashboard_energy_demand_primary_of_final.should be_within(3461122259486.18, TOLERANCE)
    end
    ...
    it "check dashboard_energy_import_netto" do
      ...
      @future.dashboard_energy_import_netto.should be_within(0.9633104353609985, TOLERANCE)
    end
    ...
    it "check dashboard_reduction_of_co2_emissions_versus_1990" do
      ...
      @future.dashboard_reduction_of_co2_emissions_versus_1990.should be_within(0.089516983010826, TOLERANCE)
    end
