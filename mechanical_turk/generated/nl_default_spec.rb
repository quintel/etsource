...
describe "untitled" do
  ...
  describe "gqueries" do
    ...
    it "dashboard_bio_footprint" do
      ...
      the_future.should  be_within(0.224, some_tolerance)
    ...
    it "dashboard_employment" do
      ...
      the_future.should  be_within(29409.913, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "dashboard_energy_demand_primary_of_final" do
      ...
      the_future.should  be_within(3461730879704.038, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "dashboard_energy_import_netto" do
      ...
      the_relative_increase.should be_within(231.8, some_tolerance)
    ...
    it "dashboard_renewability" do
      ...
      the_future.should  be_within(0.033, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "dashboard_total_costs" do
      ...
      the_future.should  be_within(48.437, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "dashboard_total_costs_assigned_to_agriculture" do
      ...
      the_future.should  be_within(2109325263.244, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "dashboard_total_costs_assigned_to_buildings" do
      ...
      the_future.should  be_within(5346359830.651, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "dashboard_total_costs_assigned_to_households" do
      ...
      the_future.should  be_within(7813038899.502, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "dashboard_total_costs_assigned_to_industry_and_energy" do
      ...
      the_future.should  be_within(23647581507.799, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "dashboard_total_costs_assigned_to_other" do
      ...
      the_future.should  be_within(1444370733.371, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "dashboard_total_costs_assigned_to_transport" do
      ...
      the_future.should  be_within(8076663885.401, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "dashboard_total_costs_per_household" do
      ...
      the_future.should  be_within(6590.563, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
