...
describe "untitled" do
  ...
  describe "gqueries" do
    ...
    it "biodiesel_in_use_of_transport_fuels" do
      ...
      the_value.should be_within(11.74, some_tolerance)
    end
      ...
      the_value.should be_within(19.704, some_tolerance)
    end
    ...
    it "biomass_in_source_of_electricity_production" do
      ...
      the_future.should  be_within(17.28, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
      ...
      the_value.should be_within(39.729, some_tolerance)
    end
      ...
      the_value.should be_within(3.036, some_tolerance)
    end

          it "biomass_plants_capacity_in_power_plant_properties" do
      the_value.should be_within(0.802, some_tolerance)
    end
      ...
      the_value.should be_within(1693.213, some_tolerance)
    end

          it "biomass_plants_plants_in_power_plant_properties" do
      the_value.should be_within(9.846, some_tolerance)
    end
      ...
      the_value.should be_within(0.625, some_tolerance)
    end
    ...
    it "co2_emission_exported_electricity_in_co2_emissions_with_import_and_export" do
      ...
      the_future.should  be_within(1.407, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "co2_emission_in_co2_emissions" do
      ...
      the_future.should  be_within(163.966, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "co2_emission_rights_in_breakdown_heating_costs" do
      ...
      the_value.should be_within(75.376, some_tolerance)
    end
      ...
      the_value.should be_within(62.21, some_tolerance)
    end
    ...
    it "coal_in_source_of_electricity_production" do
      ...
      the_future.should  be_within(99.324, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "coal_in_use_of_transport_fuels" do
      ...
      the_value.should be_within(168.574, some_tolerance)
    end
      ...
      the_value.should be_within(13.464, some_tolerance)
    end

          it "coal_power_plants_capacity_in_power_plant_properties" do
      the_value.should be_within(4.659, some_tolerance)
    end
      ...
      the_value.should be_within(7405.659, some_tolerance)
    end

          it "coal_power_plants_number_of_plants_in_power_plant_properties" do
      the_value.should be_within(6.08, some_tolerance)
    end
      ...
      the_value.should be_within(4.088, some_tolerance)
    end
    ...
    it "cost_of_capital_in_breakdown_electricity_costs" do
      ...
      the_future.should  be_within(1.72, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "cost_of_capital_in_breakdown_electricity_costs_corrected_for_electricity_imbalance" do
      ...
      the_future.should  be_within(1.669, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "cost_of_capital_in_breakdown_heating_costs" do
      ...
      the_future.should  be_within(1.342, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
      ...
      the_value.should be_within(143.364, some_tolerance)
    end

          it "costs_of_co_firing_coal_in_overview_costs_of_electricity_production" do
      the_value.should be_within(76.44, some_tolerance)
    end
      ...
      the_value.should be_within(83.148, some_tolerance)
    end
    ...
    it "depreciation_in_breakdown_electricity_costs" do
      ...
      the_future.should  be_within(1.191, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "depreciation_in_breakdown_electricity_costs_corrected_for_electricity_imbalance" do
      ...
      the_future.should  be_within(1.155, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "electricity_in_breakdown_of_total_costs" do
      ...
      the_future.should  be_within(9.925, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "electricity_in_breakdown_of_total_costs_per_household" do
      ...
      the_future.should  be_within(1350.438, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "fuel_cost_in_breakdown_electricity_costs" do
      ...
      the_future.should  be_within(6.328, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "fuel_cost_in_breakdown_electricity_costs_corrected_for_electricity_imbalance" do
      ...
      the_future.should  be_within(6.141, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "fuel_cost_in_breakdown_heating_costs" do
      ...
      the_future.should  be_within(9.53, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "fuels_in_breakdown_of_total_costs_per_household" do
      ...
      the_value.should be_within(31060244968.063, some_tolerance)
    end
      ...
      the_value.should be_within(316.892, some_tolerance)
    end
      ...
      the_value.should be_within(464.821, some_tolerance)
    end

          it "gas_in_future_energy_imports" do
      the_value.should be_within(1652.108, some_tolerance)
    end
    ...
    it "gas_in_source_of_electricity_production" do
      ...
      the_value.should be_within(649.664, some_tolerance)
    end
      ...
      the_value.should be_within(71.656, some_tolerance)
    end
      ...
      the_value.should be_within(14131.54, some_tolerance)
    end
      ...
      the_value.should be_within(4021.071, some_tolerance)
    end
      ...
      the_value.should be_within(6.357, some_tolerance)
    end
    ...
    it "geothermal_in_source_of_heat_production" do
      ...
      the_value.should be_within(0.205, some_tolerance)
    end
      ...
      the_value.should be_within(0.214, some_tolerance)
    end
    ...
    it "greengas_in_gas_network_mix" do
      ...
      the_future.should  be_within(0.981, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "heat_in_breakdown_of_total_costs" do
      ...
      the_future.should  be_within(16.858, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "heat_in_breakdown_of_total_costs_per_household" do
      ...
      the_future.should  be_within(2293.784, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "merit_order_central_gas_chp_full_load_hours_in_merit_order_table" do
      ...
      the_value.should be_within(63.213, some_tolerance)
    end
    ...
    it "merit_order_co_firing_coal_full_load_hours_in_merit_order_table" do
      ...
      the_value.should be_within(49.981, some_tolerance)
    end
    ...
    it "merit_order_coal_pwd_full_load_hours_in_merit_order_table" do
      ...
      the_value.should be_within(25.637, some_tolerance)
    end
    ...
    it "merit_order_gas_ccgt_full_load_hours_in_merit_order_table" do
      ...
      the_value.should be_within(47.955, some_tolerance)
    end
    ...
    it "merit_order_must_run_full_load_hours_in_merit_order_table" do
      ...
      the_value.should be_within(94.364, some_tolerance)
    end
    ...
    it "mv_transport_in_additional_infrastructure_investments" do
      ...
      the_value.should be_within(120.444, some_tolerance)
    end
      ...
      the_value.should be_within(330.853, some_tolerance)
    end
    ...
    it "natural_gas_in_gas_network_mix" do
      ...
      the_future.should  be_within(1629.006, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "natural_gas_in_use_of_transport_fuels" do
      ...
      the_value.should be_within(203.709, some_tolerance)
    end
    ...
    it "operation_maintenance_cost_in_breakdown_electricity_costs" do
      ...
      the_future.should  be_within(0.92, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "operation_maintenance_cost_in_breakdown_electricity_costs_corrected_for_electricity_imbalance" do
      ...
      the_future.should  be_within(0.892, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "percentage_renewable_electricity_in_renewable_electricity_share" do
      ...
      the_future.should  be_within(9.777, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "percentage_renewables_in_renewability" do
      ...
      the_future.should  be_within(3.256, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
      ...
      the_value.should be_within(4712.958, some_tolerance)
    end
    ...
    it "primary_energy_in_use_of_primary_energy" do
      ...
      the_future.should  be_within(3461.731, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "primary_energy_of_electricity_export_in_use_of_primary_energy" do
      ...
      the_future.should  be_within(25.511, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "total_investment_costs_power_production" do
      ...
      the_future.should  be_within(32009501591.642, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
    ...
    it "total_investment_costs_power_production_corrected_for_imbalance" do
      ...
      the_future.should  be_within(31060244968.063, some_tolerance)
      the_relative_increase.should be_within(0.0, some_tolerance)
      the_absolute_increase.should be_within(0.0, some_tolerance)
    end
      ...
      the_value.should be_within(32009.502, some_tolerance)
    end
